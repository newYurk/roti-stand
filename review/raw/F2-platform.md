...
| 6 | С **31.08.2026** обязателен **Play Billing 8+** | **Подтверждено, но применимо не всегда.** Это publishing gate: уже опубликованные v7-сборки продолжают проводить платежи, блокируется только выпуск нового апдейта. **Требование касается только приложений с биллингом Play.** Продление до 01.11.2026 доступно. **Версия 9 вышла в мае 2026**, прямого перехода 7→9 нет | [developer.android.com/google/play/billing/deprecation-faq](https://developer.android.com/google/play/billing/deprecation-faq) и [developer.android.com/google/play/billing/migrate-gpblv8](https://developer.android.com/google/play/billing/migrate-gpblv8), доступ 21.08.2026 |
...
| 9 | **IARC self-certification** — «бесплатный возрастной рейтинг, встроен в консоли **всех площадок**» | **Устарело / неверно для Apple.** Google Play — да, IARC. **Apple использует собственную анкету, не IARC**, и с 2025 года систему переработал | Google Play: [support.google.com/googleplay/android-developer/answer/9898843](https://support.google.com/googleplay/android-developer/answer/9898843), доступ 21.08.2026. Apple: [developer.apple.com/news/upcoming-requirements/](https://developer.apple.com/news/upcoming-requirements/), доступ 21.08.2026 — «Since January 31, 2026: Ratings for all apps and games on the App Store have been automatically updated to align with our new age rating system». Новые ступени 13+/16+/18+ добавлены к 4+/9+, старые 12+ и 17+ убраны; анонс 27.07.2025 ([macrumors.com/2025/07/25/apple-overhauls-app-store-age-ratings/](https://www.macrumors.com/2025/07/25/apple-overhauls-app-store-age-ratings/), доступ 21.08.2026) |
| 10 | **ИП/LLC не нужно на старте** | **Формально подтверждено, но чек-лист умалчивает о цене вопроса** | Apple: [developer.apple.com/support/enrollment/](https://developer.apple.com/support/enrollment/), доступ 21.08.2026 — «Your **personal legal name** will be listed as the seller on the App Store»; D-U-N-S требуется только организациям. Google Play: [support.google.com/googleplay/android-developer/answer/13628312](https://support.google.com/googleplay/android-developer/answer/13628312), доступ 21.08.2026 — для личных аккаунтов на витрине публикуются **имя, юридический адрес, email и телефон**. Для приёма денег: [developer.apple.com/help/app-store-connect/manage-agreements/sign-and-update-agreements/](https://developer.apple.com/help/app-store-connect/manage-agreements/sign-and-update-agreements/), доступ 21.08.2026 — «To sell your apps on the App Store or offer In-App Purchases, the Account Holder must sign the Paid Apps Agreement» + отдельно налоговая и банковская информация |
...
`DeviceMotionEvent` даёт **порядка 60 Гц** на большинстве устройств (диапазон по браузерам и устройствам примерно 10–60 Гц); у события есть поле `interval` с фактическим периодом дискретизации в мс — им и надо мерить, а не предполагать. Нативные iOS-приложения через CoreMotion получают акселерометр максимум около **100 Гц** независимо от запрошенного интервала ([developer.apple.com/forums/thread/813136](https://developer.apple.com/forums/thread/813136), доступ 21.08.2026).
