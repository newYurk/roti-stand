...
Схема выше нарисована не от руки: шесть путей на ней — это шесть прогонов синтетическими
PointerEvents через живой стенд вместе с вердиктом, который он вынес (три доходят до тавы,
три нет). Цвет пути — состояние автомата. Всё белое и латунное на схеме — разметка: сам стенд
не рисует ни следа пальца, ни прицела, ни конуса, а только оранжевую дугу хвата и кружок
под пальцем, и только пока жест взводится.
