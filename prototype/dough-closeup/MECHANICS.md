...
> Обновлено 16.09.2026, сборка «жарка и конверт · 2». Это описание того,
...
Это упрощённая жарка, не полная теплофизика: одна степень окраски на исходный квад,
две его стороны отдельно не считаются; коэффициенты передачи через слои ещё не
откалиброваны. Переворот, полноценное дожаривание, настоящий жест снятия, украшение и
...
Ниже параметры исходной модели. В сборке «жарка и конверт · 2» после посадки
`cookDish()` применяет их к материалу с учётом сложенных слоёв, как описано выше.
