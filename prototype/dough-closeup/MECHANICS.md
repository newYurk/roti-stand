...
> Обновлено 16.09.2026, сборка «две стороны · 3» (ветка `codex/roti-continuation`). Это описание того,
...
между захватом и концом жеста. Она делит полигоны; поднятая часть отражается и ложится
...
- Жесты жарки не реализованы. В текущей версии на таве доступно складывание, «заново» даёт новый кусочек.
